...
database were looking like this before migrations;
...
python3 manage.py migrate
```
after migrate command, database looks like this;
...
```
after changes, admin panels looks like this;

AdminPanel2.png

Question: We havent mantioned Products and Offers. we write Product and Offer as a class name. Why we see plural in admin panel?

Answer: The names "Products" and "Offers" that you see in the Django admin panel are automatically generated by Django based on the names of your models. By default, Django uses the plural form of the model class names to display them in the admin interface.
...
```
in this stage it looks like this;

ProductPage1.png


lets change it and make it special for our product;
...
after changes, i will look like this;
ProductPage2.png
